								...
								<form action="{{url('estados')}}" method="POST">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
													...
													<input type="date" required name="esp_fecha" id="esp_fecha" class="form-control @error('esp_fecha') is-invalid @enderror" value="{{date('Y-m-d')}}" readonly>
													@error('esp_fecha')
													<div class="invalid-feedback">
														{{$message}}
													</div>											
									...
									<div class="row">	
										<div class="col-md-8 offset-md-2">
											...
											<textarea class="form-control @error('esp_descripcion') is-invalid @enderror" name="esp_descripcion" id="esp_descripcion">{{old('esp_descripcion','')}}</textarea>	
