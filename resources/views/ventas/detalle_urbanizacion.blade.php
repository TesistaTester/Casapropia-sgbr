...
$(function(){
    ...
    */
    ...
    //             // "https://tile.googleapis.com/v1/2dtiles/0/0/0?session=AJVsH2wP0-pq1sK471i2OLE-lVG0RFYBknYKbO5Kl9dJYyX2nIM_UmrLJ11ZdRp2XXm5DhQG6RYrDtcwHL-W2aqKUg&key=AIzaSyAAtnmKYcYoy-wxOBHxd3YCz_KWP0MQiKU", 
    //             {
    //             maxZoom: 20,
    ...
    info.update = function (props) {
        this._div.innerHTML = '<h4 class="text-info">INFORMACION DE LA PROPIEDAD</h4>' +  (props ?
            '<h5>IDENTIFICADOR: <b>' + props.Id + '</b></h5><div class="text-center"><button class="btn btn-sm btn-info">Relacionar en BD</button></div>'
