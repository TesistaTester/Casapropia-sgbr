...
<div class="col-md-10 content-pane">
		<h3 class="title-header" style="text-transform: uppercase;">
			...
			{{$titulo}}
			<a href="{{url('lotes/'.Crypt::encryptString($lote->lot_id))}}" title="Volver a Administración de lote" data-placement="top" class="btn btn-sm btn-secondary float-right" style="margin-left:10px;"><i class="fa fa-angle-double-left"></i> ATRÁS</a>
		</h3>
					...
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								...
								<form action="{{url('modalidades_venta/'.Crypt::encryptString($modalidad->mov_id))}}" method="POST">
									@csrf
									@method('PUT')
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<select required name="mov_moneda_venta" id="mov_moneda_venta" class="form-control @error('mov_moneda_venta') is-invalid @enderror">
													...
													@if(old('mov_moneda_venta', $modalidad->mov_moneda_venta) == '0')
													<option value="0" selected>Bolivianos</option>
													@else
													<option value="0">Bolivianos</option>
													@endif
													@if(old('mov_moneda_venta', $modalidad->mov_moneda_venta) == '1')
										...
										<div class="col-md-4">
											<div class="form-group">
													...
													<select required name="mov_tipo_venta" id="mov_tipo_venta" class="form-control @error('mov_tipo_venta') is-invalid @enderror">
														<option value="">Seleccione una opción</option>
														@if(old('mov_tipo_venta', $modalidad->mov_tipo_venta) == '0')
														<option value="0" selected>AL CONTADO</option>
														@else
														<option value="0">AL CONTADO</option>
														@endif
														@if(old('mov_tipo_venta', $modalidad->mov_tipo_venta) == '1')
														<option value="1" selected>A PAGOS</option>
														@else
														<option value="1">A PAGOS</option>
														@endif
														@if(old('mov_tipo_venta', $modalidad->mov_tipo_venta) == '2')
														<option value="2" selected>A CRÉDITO</option>
														@else
										...
										<div class="col-md-4">
											...
											<input required type="number" min="0" step=".1" value="{{old('mov_precio_oferta', $modalidad->mov_precio_oferta)}}" class="form-control @error('mov_precio_oferta') is-invalid @enderror" name="mov_precio_oferta" id="mov_precio_oferta" placeholder="Precio de oferta">
										...
										<div class="col-md-4">
											...
											<input required type="number" min="0" step=".1" value="{{old('mov_precio_minimo', $modalidad->mov_precio_minimo)}}" class="form-control @error('mov_precio_minimo') is-invalid @enderror" name="mov_precio_minimo" id="mov_precio_minimo" placeholder="Precio mínimo de venta">
										...
										<div class="col-md-4" id="box-tasa-interes">
											<div class="form-group">
												...
												<input required type="number" min="0" max="100" step="1" value="{{old('mov_tasa_interes', $modalidad->mov_tasa_interes)}}" class="form-control @error('mov_tasa_interes') is-invalid @enderror" name="mov_tasa_interes" id="mov_tasa_interes" placeholder="Tasa de interes">
										...
										<div class="col-md-4" id="box-monto-interes">
											...
											<input required type="number" min="0" step=".1" value="{{old('mov_monto_interes', $modalidad->mov_monto_interes)}}" class="form-control @error('mov_monto_interes') is-invalid @enderror" name="mov_monto_interes" id="mov_monto_interes" placeholder="Monto interes">
										...
										<div class="col-md-4" id="box-cuota-inicial">
											<div class="form-group">
												...
												<input required type="number" min="0" step=".1" value="{{old('mov_cuota_inicial', $modalidad->mov_cuota_inicial)}}" class="form-control @error('mov_cuota_inicial') is-invalid @enderror" name="mov_cuota_inicial" id="mov_cuota_inicial" placeholder="Cuota inicial">
										...
										<div class="col-md-4" id="box-plazo">
											...
											<input required type="number" min="0" step="1" value="{{old('mov_plazo', $modalidad->mov_plazo)}}" class="form-control @error('mov_plazo') is-invalid @enderror" name="mov_plazo" id="mov_plazo" placeholder="Plazo">
											@error('mov_plazo')
											<div class="invalid-feedback">
												{{$message}}
											</div>											
										...
										<div class="col-md-4">
											...
											<input required type="number" min="0" step=".1" value="{{old('mov_precio_total_minimo', $modalidad->mov_precio_total_minimo)}}" class="form-control @error('mov_precio_total_minimo') is-invalid @enderror" name="mov_precio_total_minimo" id="mov_precio_total_minimo" placeholder="Precio total minimo">
	...
	<script type="text/javascript">
		$(function(){
			...
			--------------------------------------------------------------
			*/
			if($('#mov_tipo_venta').val() == '' || $('#mov_tipo_venta').val() == 0){
				$('#box-monto-interes').hide();
				$('#box-tasa-interes').hide();
				$('#box-cuota-inicial').hide();
				$('#box-plazo').hide();
			}
			if($('#mov_tipo_venta').val() == 1){
				$('#box-monto-interes').hide();
				$('#box-tasa-interes').hide();
			}
			if($('#mov_tipo_venta').val() == 2){
				$('#box-monto-interes').show();
				$('#box-tasa-interes').show();
				$('#box-cuota-inicial').show();
				$('#box-plazo').show();
			}
