					...
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								...
								<form id="form-nuevo-propietario-legal" action="{{url('propietarios_legales')}}" method="POST" data-validation1="{{url('propietarios_legales/valida_propietario')}}">
								  @csrf
									<div class="row">
										<div class="col-md-4">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
            ...
            <div class="alert alert-danger" id="alert-propietario-existe">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>
                            El número de documento ingresado ya pertenece a un propietario legal registrado.<br> <b>El formulario fue vaciado, revise los datos e intente nuevamente.</b>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>
							...
							<b>Para registrarlo como propietario legal solo debe AUTOCOMPLETAR el formulario y luego hacer clic en GUARDAR DATOS para guardar el formulario.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="btn-autocompletar" class="btn btn-primary" data-dismiss="modal">Autocompletar datos</button>
        </div>
      </div>
    </div>
  </div>
...
$(function(){
	...
	$('#per_nro_id').focusout(function(e){
				e.preventDefault();
				var rsm = $('#form-nuevo-propietario-legal').attr('data-validation1');
