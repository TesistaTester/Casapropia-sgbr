					...
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								...
								<div class="alert alert-info">
									<div class="media">
										...
										<div class="media-body">
											...
											<p>
												Tenga en cuenta que al editar los datos del propietario real no puede cambiar el número de identificación registrado.
											</p>
										</div>
									</div>
								</div>
								...
								<form id="form-editar-propietario-real" action="{{url('propietarios_reales/'.$propietario->prr_id)}}" method="POST">
									@method('PUT')
									@csrf
									<div class="row">
										<div class="col-md-4">
