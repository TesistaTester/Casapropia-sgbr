...
<script>
    $(function(){
        $('#lot_nro').change(function(e){
            let urbanizacion = $('#urb_nombre').val();
            let manzano = $('#man_id :selected').text();
            let nro_lote = $(this).val();
            let codigo_lote = nro_lote+manzano+" "+urbanizacion;
            $('#lot_codigo').val(codigo_lote);
        });        
