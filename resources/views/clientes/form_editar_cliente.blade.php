			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form enctype="multipart/form-data" id="form-nuevo-cliente" action="{{url('clientes/'.Crypt::encryptString($cliente->cli_id))}}" method="POST" data-validation1="{{url('clientes/valida_cliente')}}">
								  @csrf
								  @method('PUT')
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<p>
													...
													<br>
													- El número de documento de identificación y el tipo de cliente NO se pueden modificar.
												</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<select required name="per_tipo_persona" id="per_tipo_persona" class="form-control @error('per_tipo_persona') is-invalid @enderror" readonly>
													<option value="">Seleccione una opción</option>
													<option value="0" {{ old('per_tipo_documento', $persona->per_tipo_documento) == '0' ? 'selected' : '' }}>Persona natural</option>
													<option value="1" {{ old('per_tipo_documento', $persona->per_tipo_documento) == '1' ? 'selected' : '' }}>Persona juridica</option>
												</select>
										...
										<div class="col-md-8">
											<section id="seccion-nombre-comercial">
														<div class="form-group">
															...
															<input required type="text" value="{{old('per_nombre_comercial',$persona->per_nombre_comercial)}}" class="form-control @error('per_nombre_comercial') is-invalid @enderror" name="per_nombre_comercial" id="per_nombre_comercial" placeholder="Nombre comercial de la empresa o negocio">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required type="text" value="{{old('per_nro_id', $persona->per_nro_id)}}" class="form-control @error('per_nro_id') is-invalid @enderror" name="per_nro_id" id="per_nro_id" placeholder="Número de documento" readonly>
														@error('per_nro_id')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="text-center">
														<img src="{{asset('storage/'.$cliente->cli_foto)}}" id="preview" class="img-thumbnail" style="width:60%; margin-bottom:7px;">
													</div>
													<input type="file" name="cli_foto" id="cli_foto" class="form-control file @error('cli_foto') is-invalid @enderror" accept="image/*">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<div class="alert alert-info">
															<a class="btn btn-link" target="_blank" href="{{asset('storage/'.$cliente->cli_copia_ci)}}">
																<i class="fa fa-file"></i>
																Ver PDF documento escaneado
															</a>
														</div>

														<input type="file" value="{{old('cli_copia_ci')}}" accept="application/pdf" class="form-control @error('cli_copia_ci') is-invalid @enderror" name="cli_copia_ci" id="cli_copia_ci" placeholder="PDF documento identificación">
														@error('cli_copia_ci')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<select required class="form-control @error('dom_tipo') is-invalid @enderror" name="dom_tipo" id="dom_tipo">
																<option value="">Seleccione una opción</option>
																<option value="0" {{ old('dom_tipo', $domicilio->dom_tipo) == '0' ? 'selected' : '' }}>ALQUILER</option>
																<option value="1" {{ old('dom_tipo', $domicilio->dom_tipo) == '1' ? 'selected' : '' }}>ANTICRETICO</option>
																<option value="2" {{ old('dom_tipo', $domicilio->dom_tipo) == '2' ? 'selected' : '' }}>PROPIO</option>
																<option value="3" {{ old('dom_tipo', $domicilio->dom_tipo) == '3' ? 'selected' : '' }}>OTRO</option>
															</select>
															@error('dom_tipo')
															<div class="invalid-feedback">
																{{$message}}
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<select required name="dep_id" id="dep_id" class="form-control @error('dep_id') is-invalid @enderror" data-municipio-change="{{url('departamentos')}}" data-municipio-selected="{{$domicilio->municipio->mun_id}}">
																<option value="">Seleccione una opción</option>
																@foreach($departamentos as $item)
																<option value="{{$item->dep_id}}" {{ old('dep_id', $domicilio->municipio->departamento->dep_id) == $item->dep_id ? 'selected' : '' }}>{{$item->dep_nombre}}</option>
																@endforeach
															</select>
															@error('dep_id')
															<div class="invalid-feedback">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input required type="text" value="{{old('dom_zona', $domicilio->dom_zona)}}" class="form-control @error('dom_zona') is-invalid @enderror" name="dom_zona" id="dom_zona" placeholder="Zona">
															@error('dom_zona')
															<div class="invalid-feedback">
																{{$message}}
															</div>											
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input required type="text" value="{{old('dom_calle_avenida', $domicilio->dom_calle_avenida)}}" class="form-control @error('dom_calle_avenida') is-invalid @enderror" name="dom_calle_avenida" id="dom_calle_avenida" placeholder="Calle/Avenida">
													...
													<div class="col-md-6">
														<div class="form-group">
																...
																<input  type="text" value="{{old('dom_nro', $domicilio->dom_nro)}}" class="form-control @error('dom_nro') is-invalid @enderror" name="dom_nro" id="dom_nro" placeholder="Nro domicilio">
																@error('dom_nro')
																<div class="invalid-feedback">
																	{{$message}}
																</div>											
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" value="{{old('dom_latitud', $domicilio->dom_latitud)}}" class="form-control @error('dom_latitud') is-invalid @enderror" name="dom_latitud" id="dom_latitud" placeholder="Latitud" readonly>
															@error('dom_latitud')
															<div class="invalid-feedback">
																{{$message}}
															</div>											
													...
													<div class="col-md-6">
														<div class="form-group">
																...
																<input  type="text" value="{{old('dom_longitud', $domicilio->dom_longitud)}}" class="form-control @error('dom_longitud') is-invalid @enderror" name="dom_longitud" id="dom_longitud" placeholder="Longitud" readonly>
																@error('dom_longitud')
																<div class="invalid-feedback">
																	{{$message}}
																</div>											
											...
											<div class="form-group">
												...
												<select required name="ace_id" id="ace_id" class="form-control search-actividad-economica @error('ace_id') is-invalid @enderror">
													...
													@foreach($actividades as $item)
														<option value="{{$item->ace_id}}" {{ old('ace_id', $actividad->ace_id) == $item->ace_id ? 'selected' : '' }}>{{$item->ace_descripcion}}</option>
													@endforeach
												</select>
												@error('ace_id')
												<div class="invalid-feedback">
									...
									<section id="seccion-contacto">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input  type="email" value="{{old('cli_email', $cliente->cli_email)}}" class="form-control @error('cli_email') is-invalid @enderror" name="cli_email" id="cli_email" placeholder="E-mail">
													@error('cli_email')
													<div class="invalid-feedback">
														{{$message}}
													</div>											
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input  type="text" value="{{old('cli_telefono', $cliente->cli_telefono)}}" class="form-control @error('cli_telefono') is-invalid @enderror" name="cli_telefono" id="cli_telefono" placeholder="Nro celular">
													@error('cli_telefono')
													<div class="invalid-feedback">
														{{$message}}
													</div>											
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<input required type="text" value="{{old('pre_nombres', $persona_referencia->persona->per_nombres)}}" class="form-control @error('pre_nombres') is-invalid @enderror" name="pre_nombres" id="pre_nombres" placeholder="Nombres">
													@error('pre_nombres')
													<div class="invalid-feedback">
														{{$message}}
													</div>											
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input required type="text" value="{{old('pre_primer_apellido', $persona_referencia->persona->per_primer_apellido)}}" class="form-control @error('pre_primer_apellido') is-invalid @enderror" name="pre_primer_apellido" id="pre_primer_apellido" placeholder="Primer apellido">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input required type="text" value="{{old('pre_segundo_apellido', $persona_referencia->persona->per_segundo_apellido)}}" class="form-control @error('pre_segundo_apellido') is-invalid @enderror" name="pre_segundo_apellido" id="pre_segundo_apellido" placeholder="Segundo apellido">
											...
											<div class="col-md-3">
												<div class="form-group">
														...
														<select required class="form-control @error('pre_parentesco') is-invalid @enderror" name="pre_parentesco" id="pre_parentesco">
															<option value="">Seleccione una opción</option>
															<option value="0"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '0' ? 'selected' : '' }}>PADRE/MADRE</option>
															<option value="1"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '1' ? 'selected' : '' }}>HIJO(A)</option>
															<option value="2"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '2' ? 'selected' : '' }}>ESPOSO(A)/CONYUGUE</option>
															<option value="3"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '3' ? 'selected' : '' }}>HERMANO(A)</option>
															<option value="4"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '4' ? 'selected' : '' }}>ABUELO(A)</option>
															<option value="5"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '5' ? 'selected' : '' }}>NIETO(A)</option>
															<option value="6"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '6' ? 'selected' : '' }}>TIO(A)</option>
															<option value="7"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '7' ? 'selected' : '' }}>SOBRINO(A)</option>
															<option value="8"{{ old('pre_parentesco', $persona_referencia->pre_parentesco) == '8' ? 'selected' : '' }}>OTRO</option>
														</select>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input required type="text" value="{{old('pre_telefono', $persona_referencia->pre_telefono)}}" class="form-control @error('pre_telefono') is-invalid @enderror" name="pre_telefono" id="pre_telefono" placeholder="Nro de teléfono">
													@error('pre_telefono')
													<div class="invalid-feedback">
														{{$message}}
													</div>											
														...
														<select required multiple class="form-control select-multi @error('foc_id') is-invalid @enderror" name="foc_id[]" id="foc_id">
															...
															@foreach ($formas_contacto as $item)
																...
																@foreach($contactos as $con)
																	@if($item->foc_id == $con->foc_id)
																	@php $flag = 1; @endphp
																	@break
																	@endif
																@endforeach
																<option value="{{$item->foc_id}}" {{ old('foc_id') == $item->foc_id || $flag == 1 ? 'selected' : '' }}>{{$item->foc_medio}}</option>
															@endforeach
														</select>
													@error('foc_id[]')
													<div class="invalid-feedback">
										...
										<div class="row">
											<div class="col-md-6 offset-md-6 text-right">
												...
												<input type="hidden" name="per_id" id="per_id" value="{{Crypt::encryptString($persona->per_id)}}">
...
$(function(){
	...
	* Evento: focusout
	*/
	function load_municipios(elemento, selec){
		// e.preventDefault();
				var rsm = elemento.attr('data-municipio-change');
				var dep_id = elemento.val();
				...
				$.ajax({
						...
						success: function(data){
							...
							$(data.municipios).each(function(){
								let select_item = '';
								if(selec == 'l' && this.mun_id == elemento.attr('data-municipio-selected')){
									select_item = '<option value="'+this.mun_id+'" selected>'+this.mun_nombre.toUpperCase()+'</option>';
								}else{
									select_item = '<option value="'+this.mun_id+'">'+this.mun_nombre.toUpperCase()+'</option>';
								}
	...
	$('#dep_id').change(function(event){
		load_municipios($(this), 'u');
	});
	//cargar municipios al inicio
	load_municipios($('#dep_id'), 'l');
	...
	*/
	...
	--------------------------------------------------------------------------------------
	*/
	var latitud = $('#dom_latitud').val();
	var longitud = $('#dom_longitud').val();

	if(latitud == '0'){
		latitud == '-16.50357853577617';
	}
	if(longitud == '0'){
		longitud == '-68.16282717846254';
	}

	var mymap = L.map('mapa-domicilio').setView([latitud,longitud], 13);
	//AGREGAR MARCADOR
